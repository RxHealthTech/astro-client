...
There's nothing special about `src/components/`, but that's where we like to put any Astro/React/Vue/Svelte/Preact components. (If any)
...
#### Easy Referencing Tailwind Components
Introduce Tailwind Components with ease by using the following resource
